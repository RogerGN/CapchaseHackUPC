...
// let RADIUS = 25;
let RADIUS = [22, 22, 24, 24, 26, 26, 28, 28];
...
for w in 0..N_WORKERS {
    ...
    let positions = find_closest_colorable_tiles_to_position_equal_distance(worker_position, map, WIDTH, HEIGHT, team_color, OTHER_WORKERS_MATRIX, RADIUS[w], find_center(MY_WORKERS));
